...
public class JFAComputePass : ScriptableRenderPass {
  ...
  public JFAComputePass(ComputeShader jfaComputeShader, string initKernelName, string jumpKernelName, string profilerTag, int renderTargetId) {
